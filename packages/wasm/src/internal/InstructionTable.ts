...
export const plainOps: Record<Instr.PlainMnemonic, PlainRow> = {
  ...
  'ref.eq': uniform([0xd3], [ValType.eqref, ValType.eqref], [i32]),
  'ref.as_non_null': special([0xd4]),
  'any.convert_extern': uniform([0xfb, 26], [ValType.externref], [ValType.anyref]),
  'extern.convert_any': uniform([0xfb, 27], [ValType.anyref], [ValType.externref]),
  'ref.i31': uniform([0xfb, 28], [i32], [ValType.ref('i31')]),
  'i31.get_s': uniform([0xfb, 29], [ValType.i31ref], [i32]),
  'i31.get_u': uniform([0xfb, 30], [ValType.i31ref], [i32]),
  'array.len': uniform([0xfb, 15], [ValType.arrayref], [i32]),
...
/** Subopcodes of `0xFB`-prefixed GC instructions that carry immediates. */
export const gcOpcodes = {
  structNew: 0,
  structNewDefault: 1,
  structGet: 2,
  structGetS: 3,
