...
const f64Exact = `import silk.f64
pub fn main() -> i32 {
...
const f32Exact = `import silk.f32
pub fn main() -> i32 {
...
const minimumMaximum = `import silk.f32
import silk.f64
pub fn main() -> i32 {
 ...
 */
const squareRoot = `import silk.f32
import silk.f64
pub fn main() -> i32 {
 ...
 */
const canonicalNaN = `import silk.f32
import silk.f64
