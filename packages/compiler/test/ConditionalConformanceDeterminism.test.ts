...
it('keeps conditional conformance proofs and instances byte-identical across fresh processes', () => {
  ...
  assert.strictEqual(new Set(mappedInstances.map((instance) => instance.arguments.at(0))).size, 2)
  assert.strictEqual(
