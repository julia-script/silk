...
export const resolve = Effect.fn('CTranslationUnit.resolve')(function* (
  supply: Pick<
  ...
  dependencies: string,
  scope: string,
): Effect.fn.Return<CTranslationUnit, PlatformSupply.SupplyError, PlatformSupplyResolver.Services> {
