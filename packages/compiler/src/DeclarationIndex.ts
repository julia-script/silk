...
import type { DeclarationFact } from './internal/DeclarationFacts.js'
...
import { presentParameterEntries } from './DeclarationCollection.js'
...
export { complete } from './DeclarationCompletion.js'
export {
...
export type { CopyProof, InterfaceWitnessTarget } from './ConformanceProof.js'
export {
  conformanceCandidates,
  conforms,
  contractByCapability,
  copyAssumptions,
  copyProof,
  hasCopyDeclaration,
  interfaceOperationIntrinsic,
  interfaceWitnessImplementation,
  interfaceWitnessTarget,
  prove,
  providerMatch,
  unmappedInterfaceOperations,
  witness,
  witnessDependencyTargets,
  witnessOperation,
} from './ConformanceProof.js'
