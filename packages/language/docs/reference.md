...
- A parameter the prefix does not write and no value argument determines is `SEM0098`, which names
  that parameter rather than the whole list.
- A written type argument the value arguments contradict is `SEM0099`, reported at the type argument
