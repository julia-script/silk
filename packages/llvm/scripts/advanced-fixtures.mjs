...
const fixtureRoot = resolve(packageRoot, 'fixtures/advanced')
const moduleScript = resolve(packageRoot, 'scripts/advanced-module.mjs')
...
if (!currentText().equals(expectedText)) throw new Error('advanced textual fixture is stale')
if (!currentBitcode().equals(expectedBitcode)) throw new Error('advanced bitcode fixture is stale')

const temporary = mkdtempSync(resolve(tmpdir(), 'silk-effect-llvm-advanced-'))
try {
