...
- Added the LLVM-specific `LlvmError` tagged failure contract. Validation reports discriminated
  invalid-input and invalid-state reasons, while genuine causal failures use a wrapped-failure
  reason and JavaScript `cause`.
