...
| `maxOwned`             | Composition metadata, every staging reservation, inflate storage, and configured Zstandard window/workspace |
...
`http_body.Limits.maxOwnedBytes` and is not double-counted. Zero byte allowances are real limits.
