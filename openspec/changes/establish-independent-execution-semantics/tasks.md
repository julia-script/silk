...
- [ ] 1.1 Replace the monolithic suspendability outcome with deterministic direct/nested/external-
...
- [ ] 1.2 Add the explicit Execution propagation delimiter to reachability and verify a park-capable
...
- [ ] 2.1 Admit one exact Effect or callable representation plus sealed static-property conjuncts and
...
- [ ] 2.2 Preserve exact executable identity and ordered property obligations through forwarding,
...
- [ ] 3.1 Diagnose a park-capable complete entry with no explicit Execution delimiter independently
...
- [ ] 3.2 Add ordinary source declarations named Execution, Wake, Detached, NonParking, Scheduler,
...
- [ ] 3.3 Update canonical inspection/golden encodings for suspension modes, properties, exact bounds,
