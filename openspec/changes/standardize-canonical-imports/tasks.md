...
- [x] 2.3 Document the canonical import convention in the reference style guide and verify examples.

## 3. Integration validation

- [x] 3.1 Run pnpm typecheck, pnpm format:check, pnpm lint, pnpm test, pnpm check, and pnpm release:candidate; record exact outcomes and remaining failures.
