...
See proposal.md. layout placement, verify, and encode are the stable entry points. The RepresentationField -> CallableFieldRealization -> Layout hand-off (plan/resolve -> enrich -> place) is already layered and is preserved.
...
- **Access vocabulary**: one exported Access (or reuse Type.CallableMode) referenced by CallableFieldRealization, OpaqueRealization, Layout, and Match.
