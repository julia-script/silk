...
ordinary generic aggregate projection and nominal-union pattern selection. Valid source MUST NOT
lower to an unavailable-transform trap, an unpublished region, or a compiler implementation
exception.
