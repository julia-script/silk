...
connect, partial I/O, HUP drain, shutdown, backlog, interruption, and close cases in one optimized compiled
program per platform. Scripted clock/readiness actors cover positive waits, deadline precedence,
