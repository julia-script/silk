...
borrowed message and returns an Effect that can fail with `LogError`. A logging computation SHALL retain its Logger
...
severity, and message content through logical evaluation, native LLVM execution, and direct WebAssembly. Direct
