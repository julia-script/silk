...
- [x] 3.2 Run required repository checks and release candidate; obtain independent correctness and exact-diff test-economics approval with measured costs.
- [x] 3.3 Commit approved issue changes and provide the coordinator evidence for draft-PR handoff.
