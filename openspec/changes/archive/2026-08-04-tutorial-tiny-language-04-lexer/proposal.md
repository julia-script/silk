...
Adds tutorial example source and tests for lexing. It uses Effect error channels and repository TypeScript conventions but does not modify `@silk-effect/llvm`.
