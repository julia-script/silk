...
- [x] 2.2 Add the empty-module smoke program using public `@silklang/llvm/Builder` and `@silklang/llvm/IrText` imports.
- [x] 2.3 Document recovery for package resolution, private import, TypeScript execution, and missing-Clang problems.

## 3. Validation

- [x] 3.1 Build and pack `@silklang/llvm`, install it into the clean consumer scaffold, and run its typecheck/smoke command.
