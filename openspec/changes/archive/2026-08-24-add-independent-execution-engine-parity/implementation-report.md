...
- Initial focused command could not resolve unbuilt workspace package `@silklang/llvm/Bitcode`;
  building `@silklang/llvm` relocalized the same prerequisite to `@silklang/wasm/Binary`.
