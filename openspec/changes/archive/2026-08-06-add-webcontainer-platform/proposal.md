...
- Add a publishable `@silk-effect/platform-webcontainer` package that owns the `@webcontainer/api` boundary.
...
- Adds `packages/platform-webcontainer` and the public package `@silk-effect/platform-webcontainer`.
