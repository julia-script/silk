...
- [x] 4.4 Run required verification and release-candidate checks; obtain independent code and test-economics approval of the committed diff.
- [x] 4.5 Confirm the draft PR and JUL-174 In Review handoff with the exact reviewed head and verification evidence.
