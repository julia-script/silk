...
- [x] 2.1 Scaffold `@silk-effect/documentation` with explicit actor subpaths, workspace configuration, CommonMark dependency ownership, and package-level test configuration.
