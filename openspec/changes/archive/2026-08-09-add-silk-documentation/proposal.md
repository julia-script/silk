...
- Add an optional `@silk-effect/documentation` package that lazily and totally parses CommonMark,
...
- Affected packages: `@silk-effect/compiler`, `@silk-effect/language`, `@silk-effect/lsp`,
  `@silk-effect/compiler-cli`, and a new `@silk-effect/documentation` package.
