...
- Extends `@silklang/compiler` with explicit syntax, parser-diagnostic, and parser actors and
...
- Adds `@silklang/compiler` as a workspace dependency of the docs app and introduces a small
