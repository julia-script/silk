...
LLVM builder (`@silklang/llvm`) and emits deterministic bitcode directly — no `libLLVM`, no C
...
6. **The compiler package gains `@silklang/llvm` as a real dependency**; the release-candidate
