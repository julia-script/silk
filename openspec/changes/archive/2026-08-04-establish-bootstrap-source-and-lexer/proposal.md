...
- Add the initial `@silk-effect/compiler` package and only the public actors needed to represent a
...
- Adds `packages/compiler` as `@silk-effect/compiler` with strict TypeScript, ESM, explicit package
