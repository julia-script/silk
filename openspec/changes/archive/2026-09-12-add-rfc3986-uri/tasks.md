...
- [x] 3.1 Update callers, the consolidated native corpus, lifetime assertions, generated surfaces, docs, and PR usage examples; verify focused checks and public documentation.
- [x] 3.2 Run typecheck, format:check, lint, test, check, and release:candidate in order; record current results.
- [x] 3.3 Obtain independent code review and dedicated test-economics approval for the final committed diff; address the three review threads and confirm the updated PR and Linear baseline.
