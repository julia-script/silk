...
- [ ] 3.2 Complete independent code review and mandatory test-economics review; verify approval of the final committed diff.
- [ ] 3.3 Push a committed branch, confirm a draft PR, and update Linear to In Review with the exact head and evidence.
