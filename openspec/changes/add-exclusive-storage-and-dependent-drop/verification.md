...
| `pnpm lint`                                                           | Passed                                                                                 |
| `pnpm test`                                                           | 22 tasks passed; 2,251 compiler tests and all 311 native acceptance tests passed       |
...
The full native acceptance run took 883.77 seconds and used no corpus selector. The aggregate
...
The check did not merge main or alter the working tree. These are integration conflicts with
main's inherent-impl lifetime-elision fix, not failing tests on this branch.
