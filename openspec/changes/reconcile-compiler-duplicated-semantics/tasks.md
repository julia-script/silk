...
- [x] 1.5 Add Shared/Exclusive/Take acceptance pairs to the interface-contracts suite and verify all three paths agree

## 2. LIFO release order

- [x] 2.1 Add `inReleaseOrder` in `Ownership.ts` and verify the drop-order tests pass
- [x] 2.2 Replace the local reverses in `SuspensionOwnership.ts:362` and `Lower.ts:5819,5986` and verify ownership/suspension tests pass
...
- [x] 3.2 Add `Type.some` and collapse the five `contains*` predicates; verify tests pass
