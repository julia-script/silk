...
flushes its fixed 100 head, increments the shared informational counter, then clears the latch.
...
`Encoder.beginFinish`, drains `continueFinish`, and records exactly one completion.
