...
- `packages/compiler`: analysis snapshot query surface and supporting immutable semantic index.
...
- Public package subpaths may gain additive query types and functions. Existing LSP capabilities and
  compiler behavior remain compatible.
