...
- [ ] 2.1 Model explicit execution records, local stack roots, frame stacks, endpoint generations,
...
- [ ] 2.2 Execute one owner-selected activation synchronously until completion or relinquishment and
...
- [ ] 2.3 Emit bounded canonical events for every construction, drive, wake-order, cleanup-matrix,
...
- [ ] 4.1 Add non-LIFO alternating execution programs to the designated native differential corpus;
...
- [ ] 4.2 Cover wake inside registration, `onSuspend` destroy, wake after dormancy, execution-before-
