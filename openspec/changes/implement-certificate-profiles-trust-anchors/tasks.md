...
- [ ] 4.4 Split signature-parameter and empty-subject failures into public semantic reasons; verify exact consolidated algorithm/SAN distinctions, regenerate artifacts, and rerun the focused delivery gates.
