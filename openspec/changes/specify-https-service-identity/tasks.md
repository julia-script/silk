...
- [ ] 2.2 Strictly validate this OpenSpec change and obtain independent design review; resolve concrete findings and record commands/verdicts in validation.md.
- [ ] 2.3 Commit and push the scoped change to a draft PR before final verification; run pnpm typecheck, pnpm format:check, pnpm lint, pnpm test and pnpm check in order and record exact outcomes.
