...
The package SHALL expose expected LLVM operation failures as a yieldable `LlvmError` tagged with `LlvmError`, and SHALL export that contract from `@silk-lang/llvm/LlvmError` and the package root.
