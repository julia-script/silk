...
A generic call SHALL either supply the complete ordered type-argument list or infer every type
argument from the types of supplied call arguments. Partial explicit lists, expected return types,
and later uses MUST NOT contribute inference. Missing, conflicting, or excess arguments MUST
